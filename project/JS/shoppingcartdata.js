    ...
    추천메뉴: [
      {
        ...
        name: "풀드비프 와퍼",
        description:
          "강한 불맛패티와 부드러운 풀드비프의 만남, 결이 다른 비프가 와퍼맛을 살린다",
        price: 10000,
      ...
      },
      {
        ...
        name: "스파이시 풀드비프 와퍼",
        description:
          "매운 맛을 더한 풀드비프와 불맛 패티의 조화, 매운 맛이 일품인 버거",
        price: 10500,
      ...
      },
      {
        ...
        name: "콰트로치즈 풀드비프 와퍼",
        description:
          "4종 치즈의 풍미가 더해진 풀드비프와 와퍼의 만남, 치즈 애호가들을 위한 선택",
        price: 11000,
      ...
      },
      {
        ...
        name: "풀드비프 팩",
        description:
          "풀드비프와 와퍼를 한 번에 즐길 수 있는 든든한 팩, 두 가지 메뉴의 조화",
        price: 15000,
      ...
      },
      {
        ...
        name: "두툼버거 더블",
        description:
          "두툼한 패티가 두 겹으로 더해져서 더욱 풍성하고 만족스러운 버거",
        price: 13000,
      ...
      },
      {
        ...
        name: "몬스터 와퍼",
        description:
          "강력한 맛과 크기를 자랑하는 몬스터급 버거, 푸짐하게 즐길 수 있다",
        price: 14000,
      ...
      },
      {
        ...
        name: "불맛 더블치즈버거",
        description:
          "불맛이 가미된 두 개의 치즈 패티로 풍성한 맛을 선사하는 버거",
        price: 12500,
    ...
    프리미엄: [
      {
        ...
        name: "불맛 더블치즈버거",
        description:
          "불맛 패티와 두 겹의 치즈, 그리고 베이컨의 풍미가 어우러진 버거",
        price: 13500,
      ...
      },
      {
        ...
        name: "블랙바비큐콰트로치즈와퍼",
        description:
          "바비큐 소스와 4종 치즈가 더해져 깊고 풍성한 맛을 자랑하는 와퍼",
        price: 14500,
      ...
      },
      {
        ...
        name: "불맛 더블치즈앤베이컨버거",
        description:
          "불맛 패티와 두 겹의 치즈가 풍성하게 어우러진 고소하고 매콤한 버거",
        price: 13000,
    ...
    "와퍼&주니어": [
      {
        ...
        name: "갈릭불고기와퍼",
        description:
          "마늘의 풍미가 가득한 불고기와퍼로, 고소하고 짭짤한 맛을 선사하는 버거",
        price: 12000,
      ...
      },
      {
        ...
        name: "불고기와퍼",
        description:
          "달콤한 불고기 소스와 불고기의 풍미가 어우러진 클래식한 와퍼",
        price: 11500,
      ...
      },
      {
        ...
        name: "블랙바비큐와퍼",
        description:
          "진한 바비큐 소스와 불맛이 더해져 깊은 풍미를 자랑하는 와퍼",
        price: 12500,
    ...
    "치킨&슈림프": [
      {
        ...
        name: "BLT오믈렛킹모닝",
        description:
          "베이컨, 상추, 토마토, 오믈렛이 어우러진 아침을 위한 든든한 메뉴",
        price: 11000,
      ...
      },
      {
        ...
        name: "치킨킹",
        description:
          "바삭한 치킨 패티와 풍부한 소스가 어우러져 맛있는 치킨 버거",
        price: 12000,
    ...
    올데이킹: [
      {
        ...
        name: "몬스터 주니어",
        description:
          "몬스터와퍼의 미니 버전, 더 작은 사이즈로 푸짐한 맛을 즐길 수 있는 주니어 버거",
        price: 9500,
      ...
      },
      {
        ...
        name: "불맛 더블 치즈버거 주니어",
        description:
          "매운 불맛과 두 겹의 치즈가 어우러져 강력한 풍미를 자랑하는 버거",
        price: 12500,
      ...
      },
      {
        ...
        name: "오믈렛킹모닝",
        description:
          "부드러운 오믈렛과 신선한 재료들이 어우러진 아침을 위한 완벽한 메뉴",
        price: 11000,
